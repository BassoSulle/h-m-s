<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_lab_result']))
		{
            ...
            $lab_pat_comment = $_POST['lab_pat_comment'];
            //$pres_ins = $_POST['pres_ins'];
            //$pres_pat_ailment = $_POST['pres_pat_ailment'];
            //sql to insert captured values
			$query="UPDATE   his_laboratory  SET lab_pat_name=?, lab_pat_ailment=?, lab_pat_number=?, lab_pat_tests=?, lab_pat_results=?, lab_pat_comment=? WHERE  lab_number = ? ";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssss', $lab_pat_name, $lab_pat_ailment, $lab_pat_number, $lab_pat_tests, $lab_pat_results,$lab_pat_comment, $lab_number);
			$stmt->execute();
			/*
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Add Comment</label>
                                                        <textarea required="required"   type="text" class="form-control bold-text-input font-weight:bold" name="lab_pat_comment" id="editor1"></textarea>
                                                </div>
