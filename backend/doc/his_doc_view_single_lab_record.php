...
<!-- back the lab report to doctor -->
 <?php
if (isset($_POST['assign_to_doctor'])) {
    $pat_assigned_to = 'Doctor_with_lab_report';
                                        ...
                                        <div class="row">
                                            <div class="col-xl-5">
                                                ...
                                                <div class="tab-content pt-0">
                                                    ...
                                                    <form method="post">
                                        <div class="my-5 mb-2" align="center">
                                            <button type="submit" class="ladda-button btn btn-success btn-sm" name="assign_to_doctor" data-style="expand-right">Send to Doctor</button>
                                        </div>
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <hr>
                                                    <h2 class="align-centre"><strong>Laboratory Test</strong></h2>
                                                    <hr>
                                                    <p class="text-muted mb-4">
                                                        <?php echo $row->lab_pat_tests;?>
                                                    </p>
                                                    <hr>
                                                    <h2 class="align-centre"><strong>Laboratory Result</strong></h2>
                                                    <p class="text-muted mb-4">
                                                        <?php echo $row->lab_pat_results;?>
                                                    </p>
                                                    <hr>
                                                    <h2 class="align-centre"><strong>Comment From Laboratory</strong></h2>
                                                    <p class="text-muted mb-4">
