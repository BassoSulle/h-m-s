...
if (isset($_POST['assign_Laboratory'])) {
  ...
  //   $pat_vitals_status = 'Capttured';
    ...
    if ($stmt) {
        $success = "Patient Assigned to Laboratory";
    } else {
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-xl-4">
                            <div class="card-box text-center">
                                ...
                                <div class="text-left mt-3">
                                    ...
                                    <hr>
                                    <p class="text-muted mb-2 font-13"><strong>Date
                                            Recorded :</strong> <span
                                    ...
                                    <?php
                                            $display = '';
                                            if (($row->pat_vitals_status == "Captured") && ($row->pat_assigned_to == "Nurse") && ($row->pat_assigned_to == "Doctor")) {
                                                $display = '';
                                            }
                                        ?>
                                        <form method="post" class="d-<?php echo $display; ?>">
                                            <div class="my-1" align="center">
                                                <button type="submit" class="ladda-button btn btn-success btn-sm" name="assign_Laboratory" data-style="expand-right">Assign Laboratory</button>
                                            </div>
                                        </form>
                        ...
                        <div class="col-lg-8 col-xl-8">
                            <div class="card-box">
                                ...
                                <div class="tab-pane show" id="lab_records">
                                    <ul class="list-unstyled timeline-sm">
                                        ...
                                        <li class="timeline-sm-item">
                                            ...
                                            <hr>
                                            <h5>
                                                <strong>Comment From Laboratory</strong>
                                            </h5>

                                            <p class="text-muted mt-2">
                                                <?php echo $row->lab_pat_comment; ?>
                                            </p>
                                ...
                                <div class="mt-2" align="center"><a href="his_doc_add_single_patient_prescription.php?pat_number=<?php echo $pat_number; ?>" class="text-primary ">Add Prescription</a></div>
                                    <ul class="list-unstyled timeline-sm">
                                        <?php
