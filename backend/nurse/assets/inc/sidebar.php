                ...
                <div class="slimscroll-menu">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="his_nur_manage_patients.php">
                                    <i class="fab fa-accessible-icon "></i>
                                    <span>Nurse's Patients </span>
                                ...
                                <!-- <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_doc_manage_patient.php">Patients</a>
                                    </li>
                                    <hr>
                                    <li>
...
<!-- 
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="his_nur_view_payrolls.php">My Payrolls</a>
                                    </li>
                                </ul>
                            </li>
