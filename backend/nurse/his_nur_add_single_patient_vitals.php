<?php
	...
	include('assets/inc/config.php');
		...
		if(isset($_POST['add_patient_vitals']))
		{
            ...
            // Indicate patient vitals have been captured
            $pat_vitals_status = "Captured";
            $query2 = "UPDATE his_patients SET pat_vitals_status = ? WHERE pat_id = ?";
            $stmt2 = $mysqli -> prepare($query2);
            $stmt2 -> bind_param('si', $pat_vitals_status, $pat_id);
            $stmt2 -> execute();
			...
			*/ 
            ...
            header('location: his_nur_manage_patients.php');
