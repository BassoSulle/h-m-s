<?php
  ...
  if (isset($_POST['assign_doctor'])) {
      ...
      $pat_select_doctor=$_POST['pat_select_doctor'];
    //   $pat_vitals_status = 'Capttured';

      $query = "UPDATE his_patients SET pat_assigned_to = ?, pat_select_doctor=? WHERE pat_id = ?";
      $stmt = $mysqli -> prepare($query);
      $stmt -> bind_param('ssi', $pat_assigned_to,$pat_select_doctor, $pat_id);
      $stmt -> execute();
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        ...
                                        <?php
                                            $display = 'none';
                                            if (($row->pat_vitals_status == "Captured") && ($row->pat_assigned_to == "Nurse")) {
                                                $display = '';
                                            }
                                        ?>
                                        <form method="post" class="d-<?php echo $display; ?>">
                                        <div class="form-group ">
                                                    <label for="inputPassword4" class="col-form-label"><strong>Select Doctor</strong></label>
                                                    <select name="pat_select_doctor" id="" class="form-control">
                                                    <option value="" >-Select Doctor-</option>
                                                        <option value=" Room Number1">Room Number1</option>
                                                        <option value=" Room Number2">Room Number2</option>
                                                        <option value=" Room Number3">Room Number3</option>
                                                        <option value=" Room Number4">Room Number4</option>
                                                    </select>
                                                </div>

                                            <div class="my-1" align="center">
                                                <button type="submit" class="ladda-button btn btn-success btn-sm" name="assign_doctor" data-style="expand-right">Assign Doctor</button>
                                            </div>
                                          </div>                                                  
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <?php 
                                                        ...
                                                        $pat_vitals_status = $_GET['pat_vitals_status'];
                                                            
                                                            if ($pat_vitals_status == 'Not captured') {
                                                                echo '
                                                                <div class="mb-2" align="right"><a href="his_nur_add_single_patient_vitals.php?pat_id=' .$pat_id.  '&&pat_number=' .$pat_number. '" class="btn btn-sm btn-primary"> Capture Vitals</a></div>
                                                               '; 
                                                            }                                     
