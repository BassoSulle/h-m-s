                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4><strong>Pharmacy dashboard</strong></h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Today's Patients</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                    ...
                                    <div class="widget-rounded-circle card-box">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="text-right">
                                                    <h3 class="text-dark mt-1"></span></h3>
                                                    <p class="text-muted mb-1 text-truncate bold">My Payroll</p>
                                                </div>
                                            </div>
                                        </div> end row
                                    </div>
                        ...
                        <!-- <div class="col-xl-6">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                ...
                                                $ret="SELECT * FROM his_patients WHERE pat_assigned_to ='$assigned_to' AND pat_prescription_status='$pat_prescription_status'  ORDER BY RAND() LIMIT 100 "; 
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row->pat_fname;?> <?php // echo $row->pat_mname;?> <?php echo $row->pat_surname;?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->appo_date;?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->appo_time;?>
                                                    </td>
                                                    <td>
                                                        <?php echo $row->pat_phone;?>
                                                    </td>
                                                    <td>
                                                        <a href="his_nur_view_single_patient.php?pat_id=<?php echo $row->pat_id;?>&&pat_number=<?php echo $row->pat_number;?>&&pat_name=<?php echo $row->pat_fname;?>_<?php echo $row->pat_mname;?>_<?php echo $row->pat_surname;?>&&pat_vitals_status=<?php echo $row->pat_vitals_status; ?>" class="text-success"><i class="mdi mdi-check"></i></a>
                                                        <a href="his_nur_view_single_patient.php?pat_id=<?php echo $row->pat_id;?>&&pat_number=<?php echo $row->pat_number;?>&&pat_name=<?php echo $row->pat_fname;?>_<?php echo $row->pat_mname;?>_<?php echo $row->pat_surname;?>&&pat_vitals_status=<?php echo $row->pat_vitals_status; ?>" class="text-danger"><i class="mdi mdi-close"></i></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <?php }?>
                             ...
                             <div class="col-xl-12  justify-content-centre">
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                $pat_assigned_to = 'Doctor';
                                                $ret="SELECT * FROM his_patients WHERE pat_assigned_to = '$pat_assigned_to' ORDER BY RAND()"; 
                                                //sql code to get to ten docs  randomly
                                                $stmt= $mysqli->prepare($ret) ;
                                                $stmt->execute() ;//ok
                                                $res=$stmt->get_result();
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $row->pat_fname;?> <?php echo $row->pat_middle_name;?> <?php echo $row->pat_lname;?>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="his_doc_view_single_patient.php?pat_id=<?php echo $row->pat_id;?>&&pat_number=<?php echo $row->pat_number;?>&&pat_name=<?php echo $row->pat_fname;?>_<?php echo $row->pat_mname;?>_<?php echo $row->pat_surname;?>" class="btn btn-xs btn-success"><i class="mdi mdi-eye"></i></a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>
